...
f_trace = open("trace_result.txt", "w", encoding="utf-8")
def log(msg=""):
    print(msg, flush=True)
    f_trace.write(str(msg) + "\n")
    f_trace.flush()

log("INITIALIZING PIPELINE IMPORTS...")

import httpx
log("STEP 1: httpx imported")
from bs4 import BeautifulSoup
log("STEP 2: bs4 imported")

sys.path.insert(0, os.getcwd())

from app.config import settings
log("STEP 3: settings imported")
from app.persistence.database import SessionLocal, init_db, IS_FALLBACK_ACTIVE
log("STEP 4: database imported")
from app.persistence.models import (
    UniversalRecord, Document, DomainRecord, VerificationRecord,
    CrawlActivityLog, SearchHistory, ExtractedFact
)
log("STEP 5: models imported")
from app.storage.file_storage import file_storage
log("STEP 6: file_storage imported")
from app.crawler.quality_filter import quality_filter
log("STEP 7: quality_filter imported")
from app.persistence import repositories as repo
log("STEP 8: repo imported")
from app.normalization.normalizer import normalizer
log("STEP 9: normalizer imported")
